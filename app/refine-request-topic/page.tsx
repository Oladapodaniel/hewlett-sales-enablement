        ...
        <main className="flex items-center justify-center w-full">
            <div className="flex flex-col items-center justify-center w-1/2">
                <motion.h3
                    ...
                    className="font-[700] bg-[url('../assets/img/banner_title_zs.svg')] bg-no-repeat bg-[50%] font-[500] text-[60px] pt-[10px] px-[10px] pb-[10px] mt-8" style={{ backgroundPosition: 'right 70px' }}>Let me ask you some questions</motion.h3>
                <motion.p
                    initial={{ opacity: 0, y: -20 }}
                    animate={{ opacity: 1, y: 0 }}
